<template>
    <div class="ishow-navbarMain" @click="validateOut">
        ...
        <el-dialog title="裁切背景" v-model="dialogVisible3" top="3%">
            <div class="layer-content clearfix">
                <div class="layer-main_normal">
                    <crop v-on:afterCorp="afterCrop" :crood-url="croodUrl" :ratio="0.695" :height="460" :width="920"></crop>
                </div>
            </div>
            <div class="layer-main_footer">
        ...
        <el-dialog title="图片裁切" v-model="dialogVisible4" top="3%">
            <div class="layer-content clearfix">
                <div class="layer-main_normal">
                    <crop v-on:afterCorp="afterCrop" :crood-url="croodUrl2" :ratio="1" :height="460" :width="920"></crop>
                </div>
            </div>
            <div class="layer-main_footer">
...
export default {
    data() {
        ...
        created() {
            ...
            //图片选择
            bus.$on('update-image-layer', function(type,data) {
