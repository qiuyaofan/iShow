        ...
        <div class="layer-main_pic">
            <div class="layer-main_content">
                ...
                <div class="layer-main_box">
                    <div v-if="!isLoading">
                        <div v-for="(item,index) in json" class="layer-main_item" :key="index" :class="{ 'selected': isActive[index]}" :style="{ 'background-image': 'url(' + item + ')' }" :data-url="item"  @mouseover="picHover(index,true)" @mouseout="picHover(index,false)">
